...
function resetData() {
  ...
  const elementsList = document.querySelectorAll(
    "#tomorrowCard, #dayThreeCard, #dayFourCard"
  );
...
function createWeatherCard(
  ...
  array = [
    ...
    `Daily high: ${currentTempHigh}&#176;C`,
    `Daily Low: ${currentTempLow}&#176;C`,
  ];
  ...
  fetch(threeDayForecastAPI)
    ...
    .then((content) => {
      ...
      threeDayCard(
        ...
        tomorrowTempLow,
        dayThreeTemp,
        dayThreeWeatherCondition,
        dayThreeTempHigh,
        dayThreeTempLow,
        dayFourTemp,
        dayFourWeatherCondition,
        dayFourTempHigh,
        dayFourTempLow
      );
    })
...
function threeDayCard(
  ...
  tomorrowArray = [
    `${tomorrow}`,
    `${tomorrowWeatherCondition}`,
    `Forecast Temp: ${tomorrowTemp}&#176;C`,
    `High: ${tomorrowTempHigh}&#176;C`,
    `Low: ${tomorrowTempLow}&#176;C`,
  ];
  ...
  dayThreeArray = [
    `${dayThree}`,
    `${dayThreeWeatherCondition}`,
    `Forecast Temp: ${dayThreeTemp}&#176;C`,
    `High: ${dayThreeTempHigh}&#176;C`,
    `Low: ${dayThreeTempLow}&#176;C`,
  ];
  ...
  dayFourArray = [
    `${dayFour}`,
    `${dayFourWeatherCondition}`,
    `Forecast Temp: ${dayFourTemp}&#176;C`,
    `High: ${dayFourTempHigh}&#176;C`,
    `Low: ${dayFourTempLow}&#176;C`,
  ];
